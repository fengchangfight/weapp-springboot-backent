package com.xiaochengxu.test.controller;
...
import com.xiaochengxu.test.config.Api;
import com.xiaochengxu.test.config.ApiConstant;
import com.xiaochengxu.test.service.WxService;
import com.xiaochengxu.test.util.Aes;
...
public class WxAuthController extends BaseController{
	...
	@RequestMapping(value = PathConstants.GETSESSION, method = RequestMethod.GET, produces = "application/json")
